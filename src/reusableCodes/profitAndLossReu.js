...
// const games = Object.values(gameAbbreviations).filter(abbrev => abbrev !== game);
    ...
    if (!lastDayProfit || currentYear !== lastDayProfit.createdAt.getFullYear()) {
        ...
        const profitData = {
            ...
            fullDayProfit: profit,
            fullMonthProfit: profit,
            fullYearProfit: lastDayProfit.fullYearProfit + profit,
            fullDayLoss: loss,
            fullMonthLoss: loss,
            fullYearLoss: lastDayProfit.fullYearLoss + loss,
        ...
        const profitData = {
            ...
            currentTime: currentDateFormat,
            fullDayProfit: profit,
            fullMonthProfit: lastDayProfit.fullMonthProfit + profit,
            fullYearProfit: lastDayProfit.fullYearProfit + profit,
            fullDayLoss: loss,
            fullMonthLoss: lastDayProfit.fullMonthLoss + loss,
            fullYearLoss: lastDayProfit.fullYearLoss + loss,
            // Set the profit and loss for the current game
            [`${game}FullDayProfit`]: profit,
